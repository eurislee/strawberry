#ifndef STRAWBERRY_STRAWBERRY_H
#define STRAWBERRY_STRAWBERRY_H

#include "types.h"

#define WM_NAME                  "strawberry"
#define CONFIG_NAME              WM_NAME "rc"
#define CONFIG_HOME_ENV          "XDG_CONFIG_HOME"
#define RUNTIME_DIR_ENV          "XDG_RUNTIME_DIR"

#define STATE_PATH_TPL           "/tmp/strawberry%s_%i_%i-state"
...
#define STRAWBERRY_CLASS_NAME    "Strawberry"
#define META_WINDOW_IC      "wm\0" STRAWBERRY_CLASS_NAME
#define ROOT_WINDOW_IC      "root\0" STRAWBERRY_CLASS_NAME
#define PRESEL_FEEDBACK_I   "presel_feedback"
#define PRESEL_FEEDBACK_IC  PRESEL_FEEDBACK_I "\0" STRAWBERRY_CLASS_NAME
#define MOTION_RECORDER_I   "motion_recorder"
#define MOTION_RECORDER_IC  MOTION_RECORDER_I "\0" STRAWBERRY_CLASS_NAME
